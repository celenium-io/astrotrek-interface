...
const buildChart = (chart, data, onEnter, onLeave) => {
	...
	const marginLeft = 40
	const barWidth = (width - marginLeft - marginRight) / (data.length) - 10
	console.log(width - marginLeft - marginRight);
	console.log((width - marginLeft - marginRight) / 7 - 5);
	...
	const x = d3.scaleUtc(
		...
		[marginLeft - barWidth / 2, width - marginRight - barWidth],
	)
	...
	// const barWidth = (width - marginLeft - marginRight) / (data.length) - 5
