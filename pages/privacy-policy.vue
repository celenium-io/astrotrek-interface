	...
	<Flex direction="column" align="start" gap="40" :class="$style.wrapper" wide>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				<Text :class="$style.section_paragraph">PK Labs AG, a Swiss corporation, having its registered office at Gartenstrasse 6, Zug 6300, Switzerland, (“<b>Company</b>”, “<b>we</b>”, or “<b>us</b>”) is the operator of the Website <a href="https://astrotrek.io" :class="$style.link">https://astrotrek.io</a> (the “<b>Website</b>”).</Text>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph">For any matters, relating to data protection and to exercise your rights under Section 13, you may contact <a href="mailto:astrotrek@pklabs.me" :class="$style.link">astrotrek@pklabs.me</a> in writing by e-mail or letter to the following address: PK Labs AG, Gartenstrasse 6, Zug 6300, Switzerland</Text>
			</Flex>
		</Flex>
		...
		<Flex :class="$style.section">
			...
			<Flex :class="[$style.section, $style.section_content]">
				...
				<Text :class="$style.section_paragraph">Please do not hesitate to contact us if you have any questions regarding this Privacy Policy by contacting us at <a href="mailto:astrotrek@pklabs.me" :class="$style.link">astrotrek@pklabs.me</a>.</Text>
			</Flex>
		</Flex>
	</Flex>
</template>
